...
class Contact:
    ...
    def __init__(self, username: str, last_message: str, chat, move_to_top):
    ...
    async def load_contacts(self):
        ...
        if contacts:
            for contact in contacts:
                self.contacts.append(Contact(contact["username"], contact["last_message"], contact["chat"], self.move_contact_to_top))
        self.loaded = True
